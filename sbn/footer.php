            ...
            <div class="container">
                <div class="row bottom">
                    ...
                    <div class="col-md-6 item text">
                        <h3><strong>SBN&nbsp;</strong><br></h3>
                        <p>SBN is a company that provide user to host a room to let people to vote freely of their own.<br><br></p>
                    </div>
                    <div class="col item social"><a href="#"><i class="icon ion-social-facebook"></i></a><a href="#"><i class="icon ion-social-instagram"></i></a></div>
                </div>
                <p class="copyright">SBN © 2020</p>
            </div>
        </footer>
    </div>
